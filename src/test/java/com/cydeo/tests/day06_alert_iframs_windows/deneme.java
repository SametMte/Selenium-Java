...
public class deneme {
    public static void main(String[] args) throws InterruptedException,IOException {
        ...
        for (int yearCounter = 46; yearCounter < 86; yearCounter++) { //sitedeki 1985 in index değeri 37,2025 in index değeri 77 #58
            for (int monthCounter = 0; monthCounter < 12; monthCounter++) {
                ...
                yearSelecter.selectByIndex(yearCounter);
                ...
                //-----------------------------------------Get Value ----------------------------------------------
                    ...
                    exportToExcel(data, "Pisgah Forest 1, NC.xlsx", "Pisgah Forest 1, NC");
                    closeButton.click();
                    Thread.sleep(1500);
